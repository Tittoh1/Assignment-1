...
const indicator1 = document.querySelector("#number-indicator1")
...
const indicator2 = document.querySelector("#number-indicator2")
...
const indicator3 = document.querySelector("#number-indicator3")
